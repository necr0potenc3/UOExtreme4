...
struct LINKLIST {
	struct LINKLISTNODE* pllnHead;
	struct LINKLISTNODE* pllnTail;
	UINT uNodes;
}

struct LINKLISTNODE {
	struct LINKLIST* pll;
	struct LINKLISTNODE* pllnPrev;
	struct LINKLISTNODE* pllnNext;
	PVOID pObject;
}

LINKLISTNODE* LinkList_Node_Create(void);
void LinkList_Node_Destroy(LINKLISTNODE* plln);
void LinkList_Node_Link(LINKLIST* pll, LINKLISTNODE* pllnNew, LINKLISTNODE* pllnPrev, LINKLISTNODE* pllnNext);
void 
